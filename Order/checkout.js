document.addEventListener("DOMContentLoaded", () => {
  ...
  <div class="d-flex justify-content-between align-items-center order-li">
    ...
    <div class="d-flex align-items-center order-li">
      <button class="btn btn-sm btn-outline-secondary quantity-btn me-1" data-action="decrease" data-item="${item}">â</button>
    ...
    <div class="d-flex align-items-center order-li">
      <div class="fw-semibold mx-3">â±${itemTotal}</div>
      <button class="btn btn-sm remove-btn" data-action="remove" data-item="${item}">Ã</button>
    </div>
  </div>
  `;
